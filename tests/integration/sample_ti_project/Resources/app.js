...
(function() {
	...
	//
	// Livemium Watcher,
	// You need to include this code in your app.js to run livemium client at launch.
	// Don't forget to replace .call() method arguments by ip address and port of your running livemium server.
	//
	var Watcher = require('lib/livemium').Watcher
	 	, watcher = new Watcher();
	
	watcher.register(win);
	watcher.watch("192.168.6.146", 8128);
})();